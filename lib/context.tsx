...
import type { Produto, Loja, Carrinho, Pedido, Comerciante, Usuario } from './types'
import { lojasIniciais, pedidosIniciais } from './data'

// Re-exportar tipos para que outros arquivos importem de um so lugar
export type { Produto, Loja, Carrinho, Pedido, Comerciante, Usuario }
export type { ItemCarrinho, Endereco } from './types'
